...
// 		inBuf,
// 		keys.WithKeygenFunc(ethermintcrypto.EthermintKeygenFunc),
// 	)
// 	if err != nil {
// 		return err
// 	}
...
// 	// Converts key to Aragon Chain secp256 implementation
// 	emintKey, ok := privKey.(ethermintcrypto.PrivKeySecp256k1)
// 	if !ok {
